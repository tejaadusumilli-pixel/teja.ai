...
const CONFIG = {
    ...
    GEMINI_MODELS: {
        ...
        'gemini-2.0-flash-lite': { name: 'Gemini 2.0 Flash Lite (Paid)', provider: 'Google', contextWindow: 1048576, pricing: { prompt: 0, completion: 0 } },
        'gemini-2.0-flash': { name: 'Gemini 2.0 Flash (Paid)', provider: 'Google', contextWindow: 1048576, pricing: { prompt: 0, completion: 0 } }
    },
